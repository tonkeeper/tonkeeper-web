...
import { NFT, NFTDNS, isNFTDNS } from '@tonkeeper/core/dist/entries/nft';
...
import { ConfirmViewControllable } from '../transfer/ConfirmView';
...
const NftPreview: FC<{
  ...
  return (
    <NotificationBlock>
      ...
      {!!(isNFTDNS(nftItem) && nftItem.expiresAt) && (
        <RenewNft nftItem={nftItem} />
      )}
