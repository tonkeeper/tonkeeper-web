...
import { AmountData, AmountValue, RecipientData } from '@tonkeeper/core/dist/entries/send';
...
export const AmountView: FC<{
...
}> = ({ recipient, onClose, onBack, setAmount, asset, data, jettons, info }) => {
    ...
    const { mutateAsync, isLoading, reset } = useEstimateTransaction(recipient, jetton, jettons);
    ...
    const onInput = (value: string) => {
        const decimals = inputAmount.inFiat ? 2 : getJettonDecimals(jetton, jettons);
