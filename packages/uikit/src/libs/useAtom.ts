...
import { Atom, ReadonlyAtom, Subject, ReplaySubject } from '@tonkeeper/core/dist/entries/atom';
...
export function useSubjectValue<T>(a: Subject<T> | ReplaySubject<T>): T | undefined {
