...
export interface SendTransactionRpcResponseSuccess
  extends WalletResponseTemplateSuccess {}
...
export type SignDataRpcResponse =
...
export type TonProofItemReplyError = ConnectItemReplyError<
...
export type WalletResponse<T extends RpcMethod> =
  | WalletResponseSuccess<T>
  | WalletResponseError<T>;

export type WalletResponseError<T extends RpcMethod> = RpcResponses[T]['error'];

export type WalletResponseSuccess<T extends RpcMethod> =
  RpcResponses[T]['success'];
