...
import { baseCspConfig, cspConfigContentToArray } from '@tonkeeper/core/dist/utils/csp';
import { isMainWindowUrl } from '../constants';
...
export abstract class MainWindow {
    ...
    static async openMainWindow() {
        ...
        this.mainWindow.webContents.session.webRequest.onHeadersReceived((details, callback) => {
            ...
            /* add CSP headers */
            if (!isDev) {
                if (isMainWindowUrl(details.url)) {
                    details.responseHeaders['Content-Security-Policy'] =
                        cspConfigContentToArray(baseCspConfig);
                }
            }
